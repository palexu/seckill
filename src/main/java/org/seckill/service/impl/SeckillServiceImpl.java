...
public class SeckillServiceImpl implements SeckillService {
    ...
    //md5盐值
    private final String salt = "jfakldj98afk∆˚0l;ajfhghoL:JIHOelkjklNg¬˚";
     ...
     * 2.保证事务方法的执行时间尽可能短，不要穿插其他网络操作，RPC／HTTP请求。一定需要网络操作，将其剥离后放到上层方法中（即事务外部）
     * 3.不是所有的方法都需要事务，比如 1)只有一条修改操作 2)只读操作 等等
     *
     * @param seckillId
     * @param userPhone
     * @param md5
